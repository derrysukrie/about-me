            ...
            <div class='row'>
              <div class='col-md-3 mb-4'>
                <div className='techstack__card'>
                  <img src='images/javascript.svg' className="rounded" alt='logos' width='120' />
              ...
              <div class='col-md-3 mb-5'>
                <div className='techstack__card'>
                  <img src='images/react.svg' className="rounded" alt='logos' width='120' />
                  <div className='text-center pt-3 font-weight-bold'>
                    <span>ReactJS</span>
                  </div>
                </div>
              ...
              <div class='col-md-3 mb-5'>
                <div className='techstack__card'>
                  <img src='images/redux.svg' className="rounded" alt='logos' width='125' />
                  <div className='text-center pt-3 font-weight-bold'>
                    <span>Redux</span>
                  </div>
                </div>
